...
public class EditAnimalControllerTest {
    ...
    public void put() throws Exception {
        ...
        this.mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.put("/editAnimal")
                ...
                .andExpect(content().string("{\"ok\":true,\"response\":{\"id\":1,\"subspecies\":{\"id\":1,\"name\":\"Какой-то вид\"},\"wardens\":[{\"id\":1,\"name\":\"Арсений\",\"married\":false,\"salary\":100.98,\"birthDay\":932839200000,\"familyName\":\"Лебедев\"}],\"name\":\"Петя\",\"birthDay\":902599200000}}"));
    }
}